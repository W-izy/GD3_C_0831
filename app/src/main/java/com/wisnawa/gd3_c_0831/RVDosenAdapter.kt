...
import com.wisnawa.gd3_c_0831.entity.Dosen
...
class RVDosenAdapter (private val data:Array<Dosen>) : RecyclerView.Adapter<RVDosenAdapter.viewHolder>() {
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        // Karena kita sudah mendifinisikan dan Menghubungkan view kita
        // kita bisa memakai view tersebut damn melakukan set text pada view tersebut
